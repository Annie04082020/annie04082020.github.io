...
module mode_selector(
    input wire clk_pixel_640,
    input wire clk_pixel_1280,
    input wire clk_serial_640,
    input wire clk_serial_1280,
    input wire sw_res,
    input wire sw_dir,

    output wire sel_pixel_clk,
    output wire sel_serial_clk,
    ...
    output wire [26:0]tick_max,
    output wire [10:0]barwidth,
    output wire [10:0]active_size
);
...
assign sel_pixel_clk = sw_res ? clk_pixel_1280 : clk_pixel_640;
assign sel_serial_clk = sw_res ? clk_serial_1280 : clk_serial_640;
...
assign tick_max = sw_res ? 27'd7485119 : 27'd2516006;
assign barwidth = sw_dir ? y_pixel/8 : x_pixel/8;
assign active_size = sw_dir ? y_pixel : x_pixel;
